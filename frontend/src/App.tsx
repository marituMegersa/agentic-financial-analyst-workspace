...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Financial Analyst & SEC Filing Copilot</h1>
      <p style={{ color: '#666' }}>Multi-agent equity research, SEC 10-K filing RAG, financial ratio extraction, and portfolio optimization.</p>
